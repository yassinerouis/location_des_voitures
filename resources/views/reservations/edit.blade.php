...
<option>{{$reservation->lieu_fin}}</option>
  ...
  <option value="{{$reservation->user_id}}">{{$reservation->name}}</option>
  @foreach($user as $c)
  @if($reservation->user_id!=$c->id)
...
<div class="form-group">
  ...
  <option value="{{$reservation->car_id}}">{{$reservation->Nom}}</option>
  @foreach($car as $c)
  @if($reservation->car_id!=$c->id)
...
<input type="checkbox" id="che">Validé les supplements
    ...
    <input type="number" id="prix" class="form-control  @if($errors->get('prix')) is-invalid @endif" value="{{$reservation->prix_total}}" name="prix" >
    @if($errors->get('prix'))
...
@endif
  ...
  <select class="form-control" name="paye">
    ...
    <option>@if($reservation->has_paid=="oui") non @else oui @endif</option>
  </select>
</div>
<div class="form-group">
