...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<form action="{{url('blog_categories/'.$categorie->id) }}" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="slug" class="form-control" value="{{$categorie->slug}}" placeholder="Entrer le slug de la Catégorie" required>
  </div>
  <div class="form-group">
